...
const useStyles = () => ({
  root: {
    display: "flex",
    minHeight: (props) => (props.width < props.limit ? null : "15rem"),
    height: (props) => (props.width < props.limit ? "10rem" : null),
    ...
    "&:hover": {
      ...
      "& h4": {
        ...
        display: (props) => (props.width > props.limit ? "inherit" : "hidden"),
        zIndex: 50,
        color: "black",
      },
      "& div": {
        ...
        <DialogContent>
          <Grid container className={classes.dialogContainer}>
            ...
            <Grid item xs={12} className={classes.dialogTextGrid}>
              <DialogContentText>
                <Typography variant={width < limit ? "subtitle1" : "subtitle1"}>
                  {description}
                </Typography>
              </DialogContentText>
              <DialogContentText>
                <Typography variant={width < limit ? "subtitle2" : "subtitle1"}>
                  Stack: {tech}
                </Typography>
              </DialogContentText>
              {note && (
